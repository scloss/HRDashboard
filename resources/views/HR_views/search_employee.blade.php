										...
										<label class="col-md-2 control-label">Supervisor Name</label>
											<div class="input-group input-icon right in-grp1">
												<select name="supervisor_name" class="form-control1">
													<option value=""></option>
																	@foreach($employee_supervisor_lists as $employee) 
						                                               			@if($employee->employee_row_id == $supervisor_name) 
							                                                        <option selected value="{{$employee->employee_row_id}}">{{$employee->name}}</option>
							                                                    @else
							                                                        <option value="{{$employee->employee_row_id}}">{{$employee->name}}</option>
							                                                    @endif 
						                                                @endforeach
