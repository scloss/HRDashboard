...
<script type="text/javascript">
	...
	function myfunction(empId){
		...
		window.location = "http://172.16.136.35/HRDashboard/public/view_employee_details?empId="+empId;
	...
	function hrfunction(){
		...
		window.location = "http://172.16.136.35/HRDashboard/public/view_employee_hr";
		...
		window.location = "http://172.16.136.35/HRDashboard/public/view_employee";
		...
		<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">All Employees of Summit Communications Ltd.</h3>
...
@include('HR_views.navigation_footer')  
   ...
   <script>
		...
		app.controller('customersCtrl', function($scope, $http) {
		   ...
		   $http.post("http://172.16.136.35/HRDashboard/get_department_hr.php")
