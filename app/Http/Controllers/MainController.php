...
class MainController extends Controller {
	...
	public function get_employee_api(){
		...
		$sql_emp = "SELECT * from hr_tool_db.employee_table WHERE status='Active' ORDER BY name";
	...
	public function phoenix_get_employee_api(){
		...
		$sql_emp = "SELECT * from hr_tool_db.employee_table WHERE status='Active' AND department IN('Gateway Operations','NOC','O&M-1','O&M-2','Power & Projects','I&C- Implementation','OH- Implementation','UG- Implementation','O&M-3','COS- O&M','RSL') ORDER BY name";
		$emp_lists =  \DB::select(\DB::raw($sql_emp));
	...
	public function get_news_api(){
		...
		$sql_news = "SELECT * from hr_tool_db.news_table WHERE news_status='Active' ORDER BY news_row_create_time DESC";
	...
	public function get_event_api(){
		...
		$sql_event = "SELECT * from hr_tool_db.event_table WHERE event_status='Active' ORDER BY event_row_create_time DESC";
	...
	public function get_notice_api(){
		...
		$sql_notice = "SELECT * from hr_tool_db.notice_table WHERE notice_status='Active' ORDER BY notice_row_create_time DESC";
	...
	public function add_employee(){
		...
		$sql_department = "SELECT * FROM hr_tool_db.department_table WHERE dept_status='Active' ORDER BY dept_name";
		$department_lists =  \DB::select(\DB::raw($sql_department));

		$sql_designation = "SELECT * FROM hr_tool_db.designation_table WHERE designation_status='Active' ORDER BY designation_name";
		$designation_lists =  \DB::select(\DB::raw($sql_designation));

		$sql_division = "SELECT * FROM hr_tool_db.division_table WHERE division_status='Active' ORDER BY division_name";
		$division_lists =  \DB::select(\DB::raw($sql_division));

		$sql_job_location = "SELECT * FROM hr_tool_db.job_location_table WHERE job_location_status='Active' ORDER BY job_location_name";
		$job_location_lists =  \DB::select(\DB::raw($sql_job_location));

		$sql_office_location = "SELECT * FROM hr_tool_db.office_location_table WHERE office_location_status='Active' ORDER BY office_location_name";
		$office_location_lists =  \DB::select(\DB::raw($sql_office_location));

		$sql_section = "SELECT * FROM hr_tool_db.section_table WHERE section_status='Active' ORDER BY section_name";
		$section_lists =  \DB::select(\DB::raw($sql_section));

		$sql_supervisor = "SELECT * FROM hr_tool_db.supervisor_table WHERE supervisor_status='Active' ORDER BY supervisor_name";
		$supervisor_lists =  \DB::select(\DB::raw($sql_supervisor));

		$sql_employee = "SELECT * FROM hr_tool_db.employee_table WHERE status='Active' ORDER BY name";
		$employee_lists =  \DB::select(\DB::raw($sql_employee));



		return view('HR_views.add_employee',compact('department_lists','designation_lists','division_lists','job_location_lists','office_location_lists','section_lists','supervisor_lists','employee_lists'));
	}
	...
	public function deactivate_news(){
		...
		$update_news_table_query =  \DB::update(\DB::raw("UPDATE hr_tool_db.news_table SET news_status='deactivated' WHERE news_row_id='$news_row_id'"));
	...
	public function deactivate_notice(){
		...
		$update_notice_table_query =  \DB::update(\DB::raw("UPDATE hr_tool_db.notice_table SET notice_status='deactivated' WHERE notice_row_id='$notice_row_id'"));
	...
	public function deactivate_event(){
		...
		$update_event_table_query =  \DB::update(\DB::raw("UPDATE hr_tool_db.event_table SET event_status='deactivated' WHERE event_row_id='$event_row_id'"));
	...
	public function deactivate_image(){
		...
		$update_image_table_query =  \DB::update(\DB::raw("UPDATE hr_tool_db.image_table SET image_status='deactivated' WHERE image_row_id='$image_row_id'"));
	...
	public function view_image_gallery(){
		...
		$sql_image = "SELECT * FROM hr_tool_db.image_table ORDER BY image_row_create_date DESC";
	...
	public function view_notice(){
		...
		$sql_notice = "SELECT * FROM hr_tool_db.notice_table ORDER BY notice_row_create_time DESC";
		$notice_lists =  \DB::select(\DB::raw($sql_notice));
	...
	public function view_event(){
		...
		$sql_event = "SELECT * FROM hr_tool_db.event_table ORDER BY event_row_create_time DESC";
		$event_lists =  \DB::select(\DB::raw($sql_event));
	...
	public function view_news(){
		...
		$sql_news = "SELECT * FROM hr_tool_db.news_table ORDER BY news_row_create_time DESC";
		$news_lists =  \DB::select(\DB::raw($sql_news));
	...
	public function view_department(){
		...
		$sql_department = "SELECT DISTINCT dept_name FROM hr_tool_db.department_table WHERE dept_status='Active' ORDER BY dept_name";
		$department_lists =  \DB::select(\DB::raw($sql_department));
	...
	public function view_designation(){
		...
		$sql_designation = "SELECT DISTINCT designation_name FROM hr_tool_db.designation_table WHERE designation_status='Active' ORDER BY designation_name";
		$designation_lists =  \DB::select(\DB::raw($sql_designation));
	...
	public function view_division(){
		...
		$sql_division = "SELECT DISTINCT division_name FROM hr_tool_db.division_table WHERE division_status='Active' ORDER BY division_name";
		$division_lists =  \DB::select(\DB::raw($sql_division));
	...
	public function view_section(){
		...
		$sql_section = "SELECT DISTINCT section_name FROM hr_tool_db.section_table WHERE section_status='Active' ORDER BY section_name";
		$section_lists =  \DB::select(\DB::raw($sql_section));
	...
	public function view_supervisor(){
		...
		$sql_supervisor = "SELECT DISTINCT supervisor_name FROM hr_tool_db.supervisor_table WHERE supervisor_status='Active' ORDER BY supervisor_name";
		$supervisor_lists =  \DB::select(\DB::raw($sql_supervisor));
	...
	public function view_job_location(){
		...
		$sql_job_location = "SELECT DISTINCT job_location_name FROM hr_tool_db.job_location_table WHERE job_location_status='Active' ORDER BY job_location_name";
		$job_location_lists =  \DB::select(\DB::raw($sql_job_location));
	...
	public function view_office_location(){
		...
		$sql_office_location = "SELECT DISTINCT office_location_name FROM hr_tool_db.office_location_table WHERE office_location_status='Active' ORDER BY office_location_name";
		$office_location_lists =  \DB::select(\DB::raw($sql_office_location));
	...
	public function edit_department(){
		...
		$sql_department = "SELECT  * FROM hr_tool_db.department_table WHERE dept_name='$deptName' AND dept_status='Active'";
		$department_lists =  \DB::select(\DB::raw($sql_department));
	...
	public function edit_designation(){
		...
		$sql_designation = "SELECT  * FROM hr_tool_db.designation_table WHERE designation_name='$designationName'  AND designation_status='Active'";
		$designation_lists =  \DB::select(\DB::raw($sql_designation));
	...
	public function edit_division(){
		...
		$sql_division = "SELECT  * FROM hr_tool_db.division_table WHERE division_name='$divisionName' AND division_status='Active'";
		$division_lists =  \DB::select(\DB::raw($sql_division));
	...
	public function edit_section(){
		...
		$sql_section = "SELECT  * FROM hr_tool_db.section_table WHERE section_name='$sectionName' AND section_status='Active'";
		$section_lists =  \DB::select(\DB::raw($sql_section));
	...
	public function edit_supervisor(){
		...
		$sql_supervisor = "SELECT  * FROM hr_tool_db.supervisor_table WHERE supervisor_name='$supervisorName' AND supervisor_status='Active'";
		$supervisor_lists =  \DB::select(\DB::raw($sql_supervisor));
	...
	public function edit_job_location(){
		...
		$sql_job_location = "SELECT  * FROM hr_tool_db.job_location_table WHERE job_location_name='$jobLocationName' AND job_location_status='Active'";
		$job_location_lists =  \DB::select(\DB::raw($sql_job_location));
	...
	public function edit_office_location(){
		...
		$sql_office_location = "SELECT  * FROM hr_tool_db.office_location_table WHERE office_location_name='$officeLocationName' AND office_location_status='Active'";
		$office_location_lists =  \DB::select(\DB::raw($sql_office_location));
	...
	public function edit_employee(){
		...
		$empId = Request::get('empId');
			...
			$sql_employee = "SELECT  * FROM hr_tool_db.employee_table WHERE employee_row_id='$empId'";
			$employee_lists =  \DB::select(\DB::raw($sql_employee));
		...
		$employee_list_query = "SELECT * FROM hr_tool_db.employee_table WHERE status='Active' ORDER BY name";
		$employee_lists =  \DB::select(\DB::raw($employee_list_query));
	

		
		return view('HR_views.edit_employee',compact('employee_lists','employeeRowId','hrId','name','email','phone','designation','department','joiningDate','division','section','gender','blood_group','marital_status','job_location','office_location','supervisor_name','date_of_birth','religion','emergency_contact_name','emergency_contact_phone','relation','home_district','present_address','permanent_address','imagePath','department_lists','designation_lists','division_lists','job_location_lists','office_location_lists','section_lists','supervisor_lists'));
	...
	public function confirm_department_edit(){
		...
		$sql_department_check_active = "SELECT dept_name FROM hr_tool_db.department_table WHERE dept_name='$deptName' AND dept_status='Active'";
		...
		if($sql_department_check_active_list){
			...
			$sql_active_department = "UPDATE hr_tool_db.department_table SET dept_name='$deptName' WHERE dept_name='$prevDeptName' AND dept_status='Active'";
			$result_update_dept = \DB::update(\DB::raw($sql_active_department));

			$sql_active_employees = "UPDATE hr_tool_db.employee_table SET department='$deptName' WHERE department='$prevDeptName' AND status='Active'";
	...
	public function confirm_designation_edit(){
		...
		$sql_designation_check_active = "SELECT designation_name FROM hr_tool_db.designation_table WHERE designation_name='$designationName' AND designation_status='Active'";
		...
		if($sql_designation_check_active_list){
			...
			$sql_active_designation = "UPDATE hr_tool_db.designation_table SET designation_name='$designationName' WHERE designation_name='$prevDesignationName' AND designation_status='Active'";
			$result_update_designation = \DB::update(\DB::raw($sql_active_designation));

			$sql_active_employees = "UPDATE hr_tool_db.employee_table SET designation='$designationName' WHERE designation='$prevDesignationName' AND status='Active'";
			$result_update_emp = \DB::update(\DB::raw($sql_active_employees));
	...
	public function confirm_section_edit(){
		...
		$sql_section_check_active = "SELECT section_name FROM hr_tool_db.section_table WHERE section_name='$sectionName' AND section_status='Active'";
		...
		if($sql_section_check_active_list){
			...
			$sql_active_section = "UPDATE hr_tool_db.section_table SET section_name='$sectionName' WHERE section_name='$prevSectionName' AND section_status='Active'";
			$result_update_section = \DB::update(\DB::raw($sql_active_section));

			$sql_active_employees = "UPDATE hr_tool_db.employee_table SET section='$sectionName' WHERE section='$prevSectionName' AND status='Active'";
			$result_update_emp = \DB::update(\DB::raw($sql_active_employees));
	...
	public function confirm_division_edit(){
		...
		$sql_division_check_active = "SELECT division_name FROM hr_tool_db.division_table WHERE division_name='$divisionName' AND division_status='Active'";
		...
		if($sql_division_check_active_list){
			...
			$sql_active_division = "UPDATE hr_tool_db.division_table SET division_name='$divisionName' WHERE division_name='$prevDivisionName' AND division_status='Active'";
			$result_update_division = \DB::update(\DB::raw($sql_active_division));

			$sql_active_employees = "UPDATE hr_tool_db.employee_table SET division='$divisionName' WHERE division='$prevDivisionName' AND status='Active'";
			$result_update_emp = \DB::update(\DB::raw($sql_active_employees));
	...
	public function confirm_supervisor_edit(){
		...
		$sql_supervisor_check_active = "SELECT supervisor_name FROM hr_tool_db.supervisor_table WHERE supervisor_name='$supervisorName' AND supervisor_status='Active'";
		...
		if($sql_supervisor_check_active_list){
			...
			$sql_active_supervisor = "UPDATE hr_tool_db.supervisor_table SET supervisor_name='$supervisorName' WHERE supervisor_name='$prevSupervisorName' AND supervisor_status='Active'";
			$result_update_supervisor = \DB::update(\DB::raw($sql_active_supervisor));

			$sql_active_employees = "UPDATE hr_tool_db.employee_table SET supervisor_name='$supervisorName' WHERE supervisor_name='$prevSupervisorName' AND status='Active'";
			$result_update_emp = \DB::update(\DB::raw($sql_active_employees));
	...
	public function confirm_job_location_edit(){
		...
		$sql_job_location_check_active = "SELECT job_location_name FROM hr_tool_db.job_location_table WHERE job_location_name='$jobLocationName' AND job_location_status='Active'";
		...
		if($sql_job_location_check_active_list){
			...
			$sql_active_job_location = "UPDATE hr_tool_db.job_location_table SET job_location_name='$jobLocationName' WHERE job_location_name='$prevJobLocationName' AND job_location_status='Active'";
			$result_update_job_location = \DB::update(\DB::raw($sql_active_job_location));

			$sql_active_employees = "UPDATE hr_tool_db.employee_table SET job_location='$jobLocationName' WHERE job_location='$prevJobLocationName' AND status='Active'";
			$result_update_emp = \DB::update(\DB::raw($sql_active_employees));
	...
	public function confirm_office_location_edit(){
		...
		$sql_office_location_check_active = "SELECT office_location_name FROM hr_tool_db.office_location_table WHERE office_location_name='$officeLocationName' AND office_location_status='Active'";
		...
		if($sql_office_location_check_active_list){
			...
			$sql_active_office_location = "UPDATE hr_tool_db.office_location_table SET office_location_name='$officeLocationName' WHERE office_location_name='$prevOfficeLocationName' AND office_location_status='Active'";
			$result_update_office_location = \DB::update(\DB::raw($sql_active_office_location));

			$sql_active_employees = "UPDATE hr_tool_db.employee_table SET office_location='$officeLocationName' WHERE office_location='$prevOfficeLocationName' AND status='Active'";
			$result_update_emp = \DB::update(\DB::raw($sql_active_employees));
			...
			if(Input::hasFile('image_path'))
		        { 
		        	...
		        	$dirPath = '../employee_images/';
				 	...
				 	$sql_update = "UPDATE hr_tool_db.employee_table SET image_path='$image_source' WHERE employee_row_id='$rowId'";
	...
	public function delete_department(){
		...
		$sql_department = "SELECT  * FROM hr_tool_db.department_table WHERE dept_name='$deptName'";
		$department_lists =  \DB::select(\DB::raw($sql_department));
	...
	public function delete_designation(){
		...
		$sql_designation = "SELECT  * FROM hr_tool_db.designation_table WHERE designation_name='$designationName'";
		$designation_lists =  \DB::select(\DB::raw($sql_designation));
	...
	public function delete_division(){
		...
		$sql_division = "SELECT  * FROM hr_tool_db.division_table WHERE division_name='$divisionName'";
		$division_lists =  \DB::select(\DB::raw($sql_division));
	...
	public function delete_section(){
		...
		$sql_section = "SELECT  * FROM hr_tool_db.section_table WHERE section_name='$sectionName'";
		$section_lists =  \DB::select(\DB::raw($sql_section));
	...
	public function delete_supervisor(){
		...
		$sql_supervisor = "SELECT  * FROM hr_tool_db.supervisor_table WHERE supervisor_name='$supervisorName'";
		$supervisor_lists =  \DB::select(\DB::raw($sql_supervisor));
	...
	public function delete_job_location(){
		...
		$sql_job_location = "SELECT  * FROM hr_tool_db.job_location_table WHERE job_location_name='$jobLocationName'";
		$job_location_lists =  \DB::select(\DB::raw($sql_job_location));
	...
	public function delete_office_location(){
		...
		$sql_office_location = "SELECT  * FROM hr_tool_db.office_location_table WHERE office_location_name='$officeLocationName'";
		$office_location_lists =  \DB::select(\DB::raw($sql_office_location));
	...
	public function confirm_department_delete(){
		...
		$sql_check_employee_table = "SELECT  * FROM hr_tool_db.employee_table WHERE department='$deptName' AND status='Active'";
		...
		$sql_update = "UPDATE hr_tool_db.department_table SET dept_status='Disabled' WHERE dept_name='$deptName' AND dept_status='Active'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function confirm_designation_delete(){
		...
		$sql_check_employee_table = "SELECT  * FROM hr_tool_db.employee_table WHERE designation='$designationName' AND status='Active'";
		$employee_lists =  \DB::select(\DB::raw($sql_check_employee_table));
		...
		$sql_update = "UPDATE hr_tool_db.designation_table SET designation_status='Disabled' WHERE designation_name='$designationName' AND designation_status='Active'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function confirm_division_delete(){
		...
		$sql_check_employee_table = "SELECT  * FROM hr_tool_db.employee_table WHERE division='$divisionName' AND status='Active'";
		$employee_lists =  \DB::select(\DB::raw($sql_check_employee_table));
		...
		$sql_update = "UPDATE hr_tool_db.division_table SET division_status='Disabled' WHERE division_name='$divisionName' AND division_status='Active'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function confirm_section_delete(){
		...
		$sql_check_employee_table = "SELECT  * FROM hr_tool_db.employee_table WHERE section='$sectionName' AND status='Active'";
		$employee_lists =  \DB::select(\DB::raw($sql_check_employee_table));
		...
		$sql_update = "UPDATE hr_tool_db.section_table SET section_status='Disabled' WHERE section_name='$sectionName' AND section_status='Active'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function confirm_supervisor_delete(){
		...
		$sql_check_employee_table = "SELECT  * FROM hr_tool_db.employee_table WHERE supervisor_name='$supervisorName' AND status='Active'";
		$employee_lists =  \DB::select(\DB::raw($sql_check_employee_table));
		...
		$sql_update = "UPDATE hr_tool_db.supervisor_table SET supervisor_status='Disabled' WHERE supervisor_name='$supervisorName' AND supervisor_status='Active'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function confirm_job_location_delete(){
		...
		$sql_check_employee_table = "SELECT  * FROM hr_tool_db.employee_table WHERE job_location='$jobLocationName' AND status='Active'";
		$employee_lists =  \DB::select(\DB::raw($sql_check_employee_table));
		...
		$sql_update = "UPDATE hr_tool_db.job_location_table SET job_location_status='Disabled' WHERE job_location_name='$jobLocationName' AND job_location_status='Active'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function confirm_office_location_delete(){
		...
		$sql_check_employee_table = "SELECT  * FROM hr_tool_db.employee_table WHERE office_location='$officeLocationName' AND status='Active'";
		$employee_lists =  \DB::select(\DB::raw($sql_check_employee_table));
		...
		$sql_update = "UPDATE hr_tool_db.office_location_table SET office_location_status='Disabled' WHERE office_location_name='$officeLocationName' AND office_location_status='Active'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function confirm_employee_delete(){
		...
		$sql_update = "UPDATE hr_tool_db.employee_table SET status='Disabled',leaving_date='$leavingDate' WHERE employee_row_id='$row_id'";
		$result = \DB::update(\DB::raw($sql_update));
	...
	public function insert_employee(){
		...
		$insert_employee = "INSERT INTO hr_tool_db.employee_table (hr_id,name,designation,joining_date,division,department,section,gender,email,phone,blood_group,marital_status,job_location,office_location,supervisor_name,date_of_birth,religion,emergency_contact_name,emergency_contact_phone,relation,home_district,present_address,permanent_address,leaving_date,status) values ('".$hrId."','".$name."','".$designation."','".$joining_date."','".$division."','".$department."','".$section."','".$gender."','".$email."','".$phone."','".$blood_group."','".$marital_status."','".$job_location."','".$office_location."','".$supervisor_name."','".$date_of_birth."','".$religion."','".$emergency_contact_name."','".$emergency_contact_phone."','".$relation."','".$home_district."','".$present_address."','".$permanent_address."','0000-00=00','Active')";
		\DB::insert(\DB::raw($insert_employee));

		$result_list =  \DB::select(\DB::raw("SELECT employee_row_id FROM hr_tool_db.employee_table ORDER BY employee_row_id DESC limit 1"));
        ...
        { 
        	...
        	$dirPath = '../employee_images/';
		 	...
		 	$sql_update = "UPDATE hr_tool_db.employee_table SET image_path='$image_source' WHERE employee_row_id='$employee_row_id'";
			$result = \DB::update(\DB::raw($sql_update));
		...
		try {
			$update_jorani = file_get_contents("http://172.16.136.80/hr_update_api/public/api/bulk_employee_insert");
		}
		catch(Exception $e) {
	...
	public function insert_image(){
		...
		$insert_image = "INSERT INTO hr_tool_db.image_table (image_tag) VALUES ('".$image_tag."')";

		\DB::insert(\DB::raw($insert_image));

		$result_list =  \DB::select(\DB::raw("SELECT image_row_id FROM hr_tool_db.image_table ORDER BY image_row_id DESC limit 1"));
        ...
        { 
			...
			unlink("../gallery_images/temp.jpg");  
		 	...
		 	$sql_update = "UPDATE hr_tool_db.image_table SET image_location='$image_source' WHERE image_row_id='$image_row_id'";
			$result = \DB::update(\DB::raw($sql_update));
	...
	public function insert_news(){
			...
			$sql_insert_news = "INSERT INTO hr_tool_db.news_table (news_title,news_description,news_date) VALUES ('".$news_title."','".$news_description."','".$news_date."')";
	...
	public function insert_notice(){
			...
			$sql_insert_notice = "INSERT INTO hr_tool_db.notice_table (notice_title,notice_description,notice_date) VALUES ('".$notice_title."','".$notice_description."','".$notice_date."')";
	...
	public function insert_event(){
			...
			$sql_insert_event = "INSERT INTO hr_tool_db.event_table (event_title,event_description,event_date) VALUES ('".$event_title."','".$event_description."','".$event_date."')";
	...
	public function insert_department(){
		...
		$sql_insert_department = "INSERT INTO hr_tool_db.department_table (dept_name,dept_status) VALUES ('".$deptName."','Active')";
	...
	public function insert_designation(){
		...
		$sql_insert_designation = "INSERT INTO hr_tool_db.designation_table (designation_name,designation_status) VALUES ('".$designationName."','Active')";
	...
	public function insert_division(){
		...
		$sql_insert_division = "INSERT INTO hr_tool_db.division_table (division_name,division_status) VALUES ('".$divisionName."','Active')";
	...
	public function insert_section(){
		...
		$sql_insert_section = "INSERT INTO hr_tool_db.section_table (section_name,section_status) VALUES ('".$sectionName."','Active')";
	...
	public function insert_supervisor(){
		...
		$sql_insert_supervisor = "INSERT INTO hr_tool_db.supervisor_table (supervisor_name,supervisor_status) VALUES ('".$supervisorName."','Active')";
	...
	public function insert_job_location(){
		...
		$sql_insert_job_location = "INSERT INTO hr_tool_db.job_location_table (job_location_name,job_location_status) VALUES ('".$jobLocationName."','Active')";
	...
	public function insert_office_location(){
		...
		$sql_insert_office_location = "INSERT INTO hr_tool_db.office_location_table (office_location_name,office_location_status) VALUES ('".$officeLocationName."','Active')";
	...
	public function view_employee_details(){
		...
		foreach($employee_lists as $employee_list){
			...
			$supervisor_id = $employee_list->supervisor_name;
			
			$sql_employee_supervisor = "SELECT name FROM hr_tool_db.employee_table WHERE employee_row_id='$supervisor_id'";

			
			$employee_supervisor =  \DB::select(\DB::raw($sql_employee_supervisor));
			//print_r($employee_supervisor);
			
			
			
			if(count($employee_supervisor)>0){
				$supervisor_name = $employee_supervisor[0]->name;
			}else{
				$supervisor_name = $employee_list->supervisor_name;
			}
	...
	public function search_employee(){
		...
		$sql_employee_supervisor = "SELECT * FROM hr_tool_db.employee_table WHERE status='Active' ORDER BY name";
		$employee_supervisor_lists =  \DB::select(\DB::raw($sql_employee_supervisor));

		$search_results = \DB::select(\DB::raw("SELECT * FROM hr_tool_db.employee_table where employee_row_id='0'"));
		...
		return view('HR_views.search_employee',compact('employee_supervisor_lists','department_lists','designation_lists','division_lists','job_location_lists','office_location_lists','section_lists','supervisor_lists','search_results','hrId','name','designation','joining_date','division','department','section','gender','email','phone','blood_group','marital_status','job_location','office_location','supervisor_name','date_of_birth','religion','emergency_contact_phone','emergency_contact_name','relation','home_district','present_address','permanent_address'));
	...
	public function search(){
		...
		$sql_search = "SELECT et.*,st.name as 'supervisor_orriginal_name' 
		...
		if($hrId != '')
		{
			$sql_search .= "et.hr_id LIKE '%".$hrId."%' AND ";
		}

		else
		{
			if($name !=''){
				$sql_search .= "et.name LIKE '%".$name."%' AND ";
			}
			if($designation !=''){
				$sql_search .= "et.designation = '$designation' AND ";
			}

			if($division !=''){
				$sql_search .= "et.division = '$division' AND ";
			}
			if($department !=''){
				$sql_search .= "et.department = '$department' AND ";
			}

			if($section !=''){
				$sql_search .= "et.section ='$section' AND ";
			}

			if($gender !=''){
				$sql_search .= "et.gender ='$gender' AND ";
			}
			if($email !=''){
				$sql_search .= "et.email LIKE '%".$email."%' AND ";
			}
			if($phone !=''){
				$sql_search .= "et.phone LIKE '%".$phone."%' AND ";
			}
			if($blood_group !=''){
				$sql_search .= "et.blood_group = '$blood_group' AND ";
			}
			if($marital_status !=''){
				$sql_search .= "et.marital_status LIKE '%".$marital_status."%' AND ";
			}
			if($job_location !=''){
				$sql_search .= "et.job_location LIKE '%".$job_location."%' AND ";
			}
			if($office_location !=''){
				$sql_search .= "et.office_location LIKE '%".$office_location."%' AND ";
			}

			if($supervisor_name !=''){
				$sql_search .= "et.supervisor_name LIKE '%".$supervisor_name."%' AND ";
			}
			if($date_of_birth !=''){
				$sql_search .= "et.date_of_birth LIKE '%".$date_of_birth."%' AND ";
			}
			if($religion !=''){
				$sql_search .= "et.religion LIKE '$religion' AND ";
			}
			if($emergency_contact_name !=''){
				$sql_search .= "et.emergency_contact_name LIKE '%".$emergency_contact_name."%' AND ";
			}
			if($emergency_contact_phone !=''){
				$sql_search .= "et.emergency_contact_phone LIKE '%".$emergency_contact_phone."%' AND ";
			}
			if($relation !=''){
				$sql_search .= "et.relation LIKE '%".$relation."%' AND ";
			}
			if($home_district !=''){
				$sql_search .= "et.home_district LIKE '%".$home_district."%' AND ";
			}
			if($present_address !=''){
				$sql_search .= "et.present_address LIKE '%".$present_address."%' AND ";
			}
			if($permanent_address !=''){
				$sql_search .= "et.permanent_address LIKE '%".$permanent_address."%' AND ";
			}
			if($joining_date !=''){
				$sql_search .= "et.joining_date BETWEEN '$joining_date' AND '$joining_date_to' AND ";
			}
		} 

		$sql_search .="et.status = 'Active' ORDER BY department,hr_id"; 
		...
		if($formType=="Export"){
				...
				foreach ($search_results as $search_result) {
					...
					array_push($smallArr, $search_result->supervisor_orriginal_name);
	...
	public function login_auth(){	
		...
		$result_list =  \DB::select(\DB::raw("SELECT * FROM hr_tool_db.HR_user_table")); 
